package com.gamelandia.controller;
...
import com.gamelandia.model.Produtos;
import com.gamelandia.repository.CategoriasRepository;
import com.gamelandia.repository.ProdutosRepository;
...
public class ProdutosController {
	...
	public ResponseEntity<Produtos> post(@Valid @RequestBody Produtos produtos) {
		...
		throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "Categorias não existe!", null);
	}
